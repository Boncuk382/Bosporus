...
| 3     | Integration                     | 1. Start Mosquitto on the Pi 2. Test it from mac 3. Update ESP32 firmware(connect Wifi, publish real sensor reading via MQTT, write Python script(subscribes/writes into SQLite))       | Readings are stored persistently                | started | 11.08.2026 | |
